...
const RegForm = reduxForm({
    ...
    return (
        <StyledForm onSubmit={handleSubmit}>
            ...
            <FieldBlock>
                <StyledField name="name" component="input" type="text" placeholder="Имя"></StyledField>
                <StyledField name="surname" component="input" type="text" placeholder="Фамилия"></StyledField>
                ...
                <StyledField name="rep_password" component="input" type="password" placeholder="Подтвердите пароль"></StyledField>
            </FieldBlock>
